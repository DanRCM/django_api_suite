...
class DemoRestApiItem(APIView):
    """
    Vista para manipular un item específico (PUT, PATCH, DELETE).
    Ruta esperada: /<id>/
    """
    name = "Demo REST API Item"

    def get_item(self, item_id):
        # Método auxiliar para buscar en la lista
    ...
    def put(self, request, id):
        ...
        data = request.data
        # PUT reemplaza valores, mantenemos el ID original
    ...
    def patch(self, request, id):
        ...
        data = request.data
        # PATCH actualiza solo lo que venga en el request
        item['name'] = data.get('name', item['name'])
        item['email'] = data.get('email', item['email'])
